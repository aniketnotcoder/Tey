...
export const from = "Md Sain Sk";
export const profession = 'CFO at Courseben Technologies';
...
//PAYPAL
export const paypalPlanIdOne = "P-9CM07240FW6519903NCJRTYA";
export const paypalPlanIdTwo = "P-464162947B524105GNCJRUQY";

//RAZORPAY
export const razorpayKeyId = "rzp_test_6SpMIBmaEksHjc";
export const razorpayPlanIdOne = "plan_R1ziyVqSgd7FOA";
export const razorpayPlanIdTwo = "plan_R1zk5sJPZLGvpD";
...
//SOCIAL SIGNIN
export const googleClientId = "39020364705-24s1ghrmda205hkdredknjmv29q2g8er.apps.googleusercontent.com";
